...
package spacetablayout.spacetablayout.src.main.java.eu.long1.spacetablayout;
...
public class SpaceTabLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        defaultTabOneButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_tab_one1);
        defaultTabTwoButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_tab_two2);
        defaultTabThreeButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_tab_three3);
        defaultTabFourButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_tab_four4);
        defaultTabFiveButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_tab_five5);
    ...
    public void initialize(ViewPager viewPager, FragmentManager fragmentManager, List<Fragment> fragments) {
        ...
        if (numberOfTabs == 3 && !iconOnly) {
            ...
            tabOne.setCustomView(R.layout.icon_tab_layout1);
            tabTwo.setCustomView(R.layout.icon_tab_layout1);
            tabThree.setCustomView(R.layout.icon_tab_layout1);
            if (numberOfTabs > 3) tabFour.setCustomView(R.layout.icon_tab_layout1);
            if (numberOfTabs > 4) tabFive.setCustomView(R.layout.icon_tab_layout1);
