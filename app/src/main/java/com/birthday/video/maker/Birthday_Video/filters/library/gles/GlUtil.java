...
public class GlUtil {
    ...
    /**
     * @param textureTarget Texture Types of.
     *                      1. For cameras GLES11Ext.GL_TEXTURE_EXTERNAL_OES
     *                      2. For pictures GLES20.GL_TEXTURE_2D
     * @param minFilter     Narrow filter type (1.GL_NEAREST ; 2.GL_LINEAR)
     * @param magFilter     Zoom filter type
     * @param wrapS         X-direction edge wrap
     * @param wrapT         Y-direction edge wrap
     * @return Back to created Texture ID
     */
    private static int createTexture(int textureTarget, @Nullable Bitmap bitmap, int minFilter,
    ...
    static int createTexture(int textureTarget, Bitmap bitmap) {
