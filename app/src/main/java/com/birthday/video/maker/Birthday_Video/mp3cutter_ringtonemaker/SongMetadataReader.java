package com.birthday.video.maker.Birthday_Video.mp3cutter_ringtonemaker;
...
public class SongMetadataReader {
    ...
    public SongMetadataReader(Context activity, String filename) {
        context = activity;
        mFilename = filename;
    ...
    private void ReadMetadata() {
        ...
        new Thread(() -> {
            try {
                c = context.getContentResolver().query(GENRES_URI, new String[]{MediaStore.Audio.Genres._ID, MediaStore.Audio.Genres.NAME}, null, null, null);
