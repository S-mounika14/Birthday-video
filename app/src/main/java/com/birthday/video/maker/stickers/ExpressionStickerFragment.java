...
public class ExpressionStickerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            pathForStoringExpressionStickersInPhone = Constants.getExternalString(context) + "/" + Constants.PROJECT_FOLDER + "/.ExpressionStickers/";
            File folder = new File(pathForStoringExpressionStickersInPhone);
            if (!folder.exists()) {
    ...
    public static ExpressionStickerFragment createNewInstance() {

        return new ExpressionStickerFragment();
    }
    ...
    private class GridViewAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            try {
                ...
                flag.setContentDescription("expression" + str + " " + "sticker");
                ...
                main.setOnClickListener(arg0 -> new Handler(Looper.getMainLooper()).postDelayed(() -> itemClickedListener.onStickerItemClicked("ExpressionStickers", position, paths.get(position)), 300));
            } catch (Exception e) {
                e.printStackTrace();
            }
