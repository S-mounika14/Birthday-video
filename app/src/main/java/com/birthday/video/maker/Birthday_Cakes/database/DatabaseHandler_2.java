...
public class DatabaseHandler_2 extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "NAMEMAKER_DB2";
    ...
    private DatabaseHandler_2(Context context) {
        super(context, DATABASE_NAME, null, 1);
    }

    public static DatabaseHandler_2 getDbHandler(Context context) {
        return new DatabaseHandler_2(context);
    }
