package com.birthday.video.maker.animation.type;
...
import com.birthday.video.maker.animation.controller.ValueController;
import com.birthday.video.maker.animation.data.Value;
import com.birthday.video.maker.animation.data.type.ColorAnimationValue;
...
public class ColorAnimation extends BaseAnimation<ValueAnimator> {
    ...
    public ValueAnimator createAnimator() {
        ...
        animator.addUpdateListener(this::onAnimateUpdated);
    ...
    private void onAnimateUpdated(@NonNull ValueAnimator animation) {
        ...
        if (listener != null) {
            listener.onValueUpdated((Value) value);
        }
    }
}
