...
public class SmileyStickerFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            pathForStoringSmileyStickersInPhone = Constants.getExternalString(context) + "/" + Constants.PROJECT_FOLDER + "/.SmileyStickers/";
            File folder = new File(pathForStoringSmileyStickersInPhone);
            if (!folder.exists()) {
    ...
    public static SmileyStickerFragment createNewInstance() {

        return new SmileyStickerFragment();
    }
    ...
    public class GridViewAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            @SuppressLint("ViewHolder") View itemView = Objects.requireNonNull(inflater).inflate(R.layout.sticker, parent, false);
            ...
            try {
                ...
                flag.setContentDescription("smiley" + str + " " + "sticker");
                ...
                main.setOnClickListener(arg0 -> new Handler(Looper.getMainLooper()).postDelayed(() -> itemClickedListener.onStickerItemClicked("SmileyStickers", position, paths.get(position)), 300));
            } catch (Exception e) {
                e.printStackTrace();
            }
