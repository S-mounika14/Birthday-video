...
public class Bubble_to_up {
	...
	public Bubble_to_up(Bitmap source, int canvasHeight, int canvasWidth) {
		...
		bitmap = Bitmap.createScaledBitmap(source, width / 2, height / 2, true);
	...
	public void drawLeaf(Canvas canvas, Paint paint) {
		canvas.drawBitmap(bitmap, x - 50, y, fadePaint);
	}
