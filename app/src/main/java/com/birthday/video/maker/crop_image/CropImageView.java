...
//    private final ProgressBar mProgressBar;
    private final RelativeLayout mCropLoading;
     ...
     */
    public WeakReference<BitmapLoadingWorkerTask> mBitmapLoadingWorkerTask;
    ...
    public CropImageView(Context context, AttributeSet attrs) {
        ...
        mCropLoading = v.findViewById(R.id.cropLoading);
    ...
    public boolean getFixedAspectRatio() {
       return mCropOverlayView.mFixAspectRatio;
    }
    ...
    private void setProgressBarVisibility() {
        ...
        mCropLoading.setVisibility(visible ? VISIBLE : INVISIBLE);
    }
