...
public class CharacterStickerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            pathForStoringCharacterStickersInPhone = Constants.getExternalString(context) + "/" + Constants.PROJECT_FOLDER + "/.CharacterStickers/";
            File folder = new File(pathForStoringCharacterStickersInPhone);
            if (!folder.exists()) {
    ...
    public static CharacterStickerFragment createNewInstance() {

        return new CharacterStickerFragment();
    }
    ...
    private class GridViewAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            try {
                ...
                flag.setContentDescription("character" + str + " " + "sticker");
                ...
                main.setOnClickListener(arg0 -> new Handler(Looper.getMainLooper()).postDelayed(() -> itemClickedListener.onStickerItemClicked("CharacterStickers", position, paths.get(position)), 300));
            } catch (Exception e) {
                e.printStackTrace();
            }
