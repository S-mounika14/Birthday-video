...
public class ShadowLay extends FrameLayout {
    ...
    public ShadowLay(Context context) {
        super(context);
        initView(context, null);
    }

    public ShadowLay(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public ShadowLay(Context context, AttributeSet attrs, int defStyleAttr) {
