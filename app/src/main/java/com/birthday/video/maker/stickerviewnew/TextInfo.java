...
public class TextInfo {
    ...
    public int getTEXT_ALPHA1() {
        return TEXT_ALPHA1;
    }

    public void setTEXT_ALPHA1(int TEXT_ALPHA1) {
        this.TEXT_ALPHA1 = TEXT_ALPHA1;
    }

    private int TEXT_ALPHA1 = 100;
    ...
    public void setXRotateProg(float XRotateProg) {
        this.XRotateProg = XRotateProg;
    }
    ...
    public void setYRotateProg(float YRotateProg) {
        this.YRotateProg = YRotateProg;
    }

    public float getZRotateProg() {
        return this.ZRotateProg;
    }

    public void setZRotateProg(float ZRotateProg) {
        this.ZRotateProg = ZRotateProg;
    }
