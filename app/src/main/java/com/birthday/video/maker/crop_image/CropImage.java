...
public final class CropImage {
     ...
     */
    static final String CROP_IMAGE_EXTRA_BUNDLE = "CROP_IMAGE_EXTRA_BUNDLE";
     ...
     * specific request.
     */
    static final int PICK_IMAGE_CHOOSER_REQUEST_CODE = 200;

    /**
     * The request code used to request permission to pick image from external storage.
     */
    static final int PICK_IMAGE_PERMISSIONS_REQUEST_CODE = 201;

    /**
     * The request code used to request permission to capture image from camera.
     */
    static final int CAMERA_CAPTURE_PERMISSIONS_REQUEST_CODE = 2011;
     ...
     */
    private static Intent getPickImageChooserIntent(
    ...
    public static ActivityBuilder activity() {
        return new ActivityBuilder(null,false,null);
    }


    public static ActivityBuilder activity(@Nullable Uri uri, boolean user_upload, UserData user_data) {
        return new ActivityBuilder(uri,user_upload,user_data);
    }
    ...
    public static final class ActivityBuilder {
        ...
        private String CROP_IMAGE_PATH = "IMAGE_PATH";

        private ActivityBuilder(@Nullable Uri source, boolean userUpload, UserData userData) {
            mSource = source;
...
//                bundle.putBoolean("user_upload",true);
//            }
