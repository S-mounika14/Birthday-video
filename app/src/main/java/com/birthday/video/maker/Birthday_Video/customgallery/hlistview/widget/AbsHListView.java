...
import com.birthday.video.maker.Birthday_Video.customgallery.hlistview.util.v11.MultiChoiceModeListener;
import com.birthday.video.maker.Birthday_Video.customgallery.hlistview.util.v11.MultiChoiceModeWrapper;
...
public abstract class AbsHListView extends AdapterView<ListAdapter> implements ViewTreeObserver.OnGlobalLayoutListener,
	...
	public boolean performItemClick(View view, int position, long id ) {
		...
		if ( mChoiceMode != ListView.CHOICE_MODE_NONE ) {
			...
			if ( mChoiceMode == ListView.CHOICE_MODE_MULTIPLE
					|| ( Build.VERSION.SDK_INT >= 11 && mChoiceMode == ListView.CHOICE_MODE_MULTIPLE_MODAL && mChoiceActionMode != null ) ) {
	...
	public Parcelable onSaveInstanceState() {
		...
		ss.filter = null;
		ss.inActionMode = Build.VERSION.SDK_INT >= 11 && mChoiceMode == ListView.CHOICE_MODE_MULTIPLE_MODAL
				&& mChoiceActionMode != null;
	...
	protected void onFocusChanged( boolean gainFocus, int direction, Rect previouslyFocusedRect ) {
		...
		if ( gainFocus && mSelectedPosition < 0 && !isInTouchMode() ) {
			if ( !mIsAttached && mAdapter != null ) {
				// Image may have changed while we were detached and it's valid
	...
	protected void onAttachedToWindow() {
		...
		if ( mAdapter != null && mDataSetObserver == null ) {
			...
			// Image may have changed while we were detached. Refresh.
			mDataChanged = true;
			mOldItemCount = mItemCount;
			mItemCount = mAdapter.getCount();
		}
	...
	public static class LayoutParams extends ViewGroup.LayoutParams {
		...
		/**
		 * View type for this view, as returned by {@link Adapter#getItemViewType(int) }
		 */
		public int viewType;
