...
class ShareSaveAdapter extends RecyclerView.Adapter<ShareSaveAdapter.MyViewHolder> {
    ...
    public ShareSaveAdapter(PackageManager pm, List<ResolveInfo> apps, Activity context, Intent intent, Uri b, String from) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int pos) {
        ...
        holder.icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    if (from.equals("photoshare_frame")) {
                    ...
                    } else if (from.equals("photoshare_gif")) {
                        ResolveInfo launchable = apps.get(pos);
                        ActivityInfo activity = launchable.activityInfo;
                        ComponentName name = new ComponentName(activity.applicationInfo.packageName,
                                activity.name);
                    ...
                    } else if (from.equals("photoshare_video")) {
                        ResolveInfo launchable = apps.get(pos);
                        ActivityInfo activity = launchable.activityInfo;
                        ComponentName name = new ComponentName(activity.applicationInfo.packageName,
                                activity.name);
