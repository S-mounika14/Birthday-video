...
public class DatabaseHandler_3 extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_TEXT_INFO = "CREATE TABLE TEXT_INFO(TEXT_ID INTEGER PRIMARY KEY,TEMPLATE_ID TEXT,newTEXT TEXT,textColor TEXT,rotate TEXT,textWidth TEXT,textHeight TEXT,POS_X TEXT,POS_Y TEXT)";
    ...
    private DatabaseHandler_3(Context context) {
        super(context, DATABASE_NAME, null, 1);
    }

    public static DatabaseHandler_3 getDbHandler(Context context) {
        return new DatabaseHandler_3(context);
    }
