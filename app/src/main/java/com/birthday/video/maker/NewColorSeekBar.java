...
public class NewColorSeekBar extends View {
    private int[] mColorSeeds = new int[]{0xFF000000, 0xFF0000FF, 0xFF9900FF, 0xFF00FF00, 0xFF00FFFF, 0xFFFF0000, 0xFFFF00FF, 0xFFFF6600, 0xFFFFFF00, 0xFFFFFFFF, 0xFF000000};
    private int c1;
    private int mAlpha;
    private int mRed;
    private int mGreen;
    ...
    public NewColorSeekBar(Context context) {
        super(context);
        init(context, null, 0, 0);
    }

    public NewColorSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, 0);
    }

    public NewColorSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, 0);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public NewColorSeekBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int barHeight = mIsShowAlphaBar ? mBarHeight * 20 : mBarHeight;
    ...
    protected void applyStyle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mBarHeight = (int) a.getDimension(R.styleable.ColorSeekBar_barHeight, (float) dp2px(20));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(thumbX, thumbY, mBarHeight / 20 + 20, colorPaint);
        ...
        if (mIsShowAlphaBar) {
            ...
            canvas.drawCircle(alphaThumbX, alphaThumbY, mBarHeight / 5 + 15, colorPaint);
