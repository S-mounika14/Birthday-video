...
public class MultiShareActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            contextWeakReference = new WeakReference<>(MultiShareActivity.this);
        ...
        protected void bindView(View convertView, int listPosition, int viewType) {
            try {
                ...
                convertView.findViewById(R.id.expand_layout).setOnClickListener(v ->
                        new Handler(Looper.getMainLooper()).postDelayed(MultiShareActivity.this::showImageFullscreen, 100));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
